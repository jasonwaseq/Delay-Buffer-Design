...
def test_each(test_name, simulator, width_p, delay_p):
    ...
    runner(simulator, timescale, tbpath, parameters, testname=test_name, pymodule="test_srldelaybuffer")
...
def test_all(simulator, width_p, delay_p):
    ...
    parameters = dict(locals())
    del parameters['simulator']
    runner(simulator, timescale, tbpath, parameters, pymodule="test_srldelaybuffer")
