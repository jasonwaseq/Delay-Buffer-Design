...
def test_each(test_name, simulator, width_p, delay_p):
    ...
    runner(simulator, timescale, tbpath, parameters, testname=test_name, pymodule="test_regdelaybuffer")
...
def test_all(simulator, width_p, delay_p):
    ...
    parameters = dict(locals())
    del parameters['simulator']
    runner(simulator, timescale, tbpath, parameters, pymodule="test_regdelaybuffer")
...
def test_lint(simulator, width_p, delay_p):
    ...
    parameters = dict(locals())
    del parameters['simulator']
    lint(simulator, timescale, tbpath, parameters, pymodule="test_regdelaybuffer")
...
def test_style(simulator, width_p, delay_p):
    ...
    parameters = dict(locals())
    del parameters['simulator']
    lint(simulator, timescale, tbpath, parameters, compile_args=["--lint-only", "-Wwarn-style", "-Wno-lint"], pymodule="test_regdelaybuffer")
